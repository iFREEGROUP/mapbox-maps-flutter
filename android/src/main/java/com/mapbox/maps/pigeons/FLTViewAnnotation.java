...
public class FLTViewAnnotation {
    ...
    public static class OnViewAnnotationUpdatedListener {
        ...
        public void onViewAnnotationPositionUpdated(@NonNull Long viewIdArg, @NonNull FLTMapInterfaces.ScreenCoordinate leftTopCoordinateArg, @NonNull Double widthArg, @NonNull Double heightArg, @NonNull VoidResult result) {
